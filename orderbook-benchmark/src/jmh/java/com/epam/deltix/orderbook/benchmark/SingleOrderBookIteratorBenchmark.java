...
public class SingleOrderBookIteratorBenchmark extends AbstractOrderBookBenchmarkAll {
    ...
    public static void main(final String[] args) throws RunnerException {
        final Options opt = new OptionsBuilder()
                .include(SingleOrderBookIteratorBenchmark.class.getSimpleName())
                .build();
        new Runner(opt).run();
    }
    ...
    @Benchmark
    public void quoteIterator() {
        final Iterator<OrderBookQuote> iterator = orderBook.getMarketSide(QuoteSide.BID).iterator();
