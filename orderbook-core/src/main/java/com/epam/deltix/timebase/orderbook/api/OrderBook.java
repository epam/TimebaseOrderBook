 ...
 * •	PERIODICAL_SNAPSHOT Synthetic snapshot generated by EPAM Market Data Aggregation software to simplify data validation and allow late joiners (consumers that appear in the middle of trading session).
