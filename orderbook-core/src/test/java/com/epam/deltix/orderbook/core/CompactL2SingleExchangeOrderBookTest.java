 ...
 */
public class CompactL2SingleExchangeOrderBookTest extends AbstractL2QuoteLevelTest {
    ...
    public void incrementalUpdate_Insert_L2Quote(final int maxExchangeDepth,
        ...
        assertSize(side, priceLevel, size);
    }
    ...
    // NOT VERY CLEAN
    // but done to avoid changes to the abstract class' test, which is relevant for other order book types
    @Override
