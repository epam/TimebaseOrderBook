...
public class OrderBook_01_L1_SingleExchangeOrderBook extends AbstractSample {
    ...
    public static void main(String[] args) {
        ...
        orderBook.update(createL1VendorUpdate(marketDepth, exchangeId, symbol));
        ...
        System.out.println(System.lineSeparator());
        orderBook.getMarketSide(QuoteSide.ASK).forEach((Predicate<OrderBookQuote>) OrderBook_01_L1_SingleExchangeOrderBook::printOrderBookLevel);
        ...
        orderBook.getMarketSide(QuoteSide.ASK)
                .forEach(OrderBook_01_L1_SingleExchangeOrderBook::quoteViewAccumulatorAction, priceAccumulator);
